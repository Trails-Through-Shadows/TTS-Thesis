...
Návrh této stolní hry počítá s několika fyzickými komponentami, které budou mít hráči k dispozici. Mezi tyto komponenty patří herní plocha, figurky postav a nepřátel, karty s předměty a karty s hráčskými akcemi.
...
Z důvodu časové náročnosti a nákladů bylo rozhodnuto, ve prospěch 2D tisku. Figurky budou opatřeny plastovým stojánkem. Jedno z předešlých řešení by však mohlo být použito pro prémiové vydání hry.