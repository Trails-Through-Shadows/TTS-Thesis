...
Na závěr celého vývoje byla vytvořena herní příručka přiložená v příloze \ref{chap:rulebook}, která obsahuje veškeré informace o hře, které hráči potřebují k jejímu odehrání vědět. Byla vytvořena pomocí nástroje \devTool{Homebrewery}{https://homebrewery.naturalcrit.com/}, který umožňuje vytvářet dokumenty v stylu \textit{Dungeons and Dragons}. Aby se příručka od tohoto velmi známého formátu odlišovala, byly použity vlastní obrázky a styly, které byly vytvořeny v rámci projektu. Jako celý projekt byla i tato příručka vytvořena v anglickém jazyce.
