...
Hlavním řešenou oblastí byla samotná implementace herního modelu, který byl základem celé hry, ale jak je možné vidět z diagramu \ref{fig:job_distribution}, během vývoje vznikla potřeba řešit i menší dílčí části. Tato kapitola se zaměřuje na poznatky a problémy, které byly řešeny v průběhu vývoje.
