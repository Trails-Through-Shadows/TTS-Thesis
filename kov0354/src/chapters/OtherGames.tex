...
Samotné mapy jednotlivých lokací jsou tvořeny spojováním hexagonových místností, jejichž rozložení hráčům ukazuje kniha scénářů. Po rozvržení místností se herní plocha může ozvláštnit více pomocí samostatných hexagonových tokenů, které se pokládají na políčka, která reprezentují překážky, pasti, dveře, nebo jiné herní prvky.
