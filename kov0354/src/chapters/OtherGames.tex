...
\begin{table}[H]
	...
	\begin{tabular}{c r@{}l c c c}
		\toprule
		& \multicolumn{1}{r}{\textbf{Cena} \footnotemark} &
...
\footnotetext{Cena v korunách je získána z webu \url{https://eshop.albi.cz/} a je aktuální k datu 21.2.2024.}
\footnotetext{Jedná se o cenu za základní tři knihy v korunách, které jsou potřeba k hraní. Informace je získána z webu \url{https://www.dndbeyond.com//} a je aktuální k datu 21.2.2024.}
