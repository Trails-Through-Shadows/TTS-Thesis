...
\subsubsection*{Herní deska a kniha lokací}
...
\subsubsection*{Role a listy postav}
...
\begin{itemize}
    \item Lodní písař: Stará se o lodní deník.
    \item Kormidelník: Hlídá věhlas, který určuje iniciativu při výběru akcí.
    \item První důstojník: Hlídá nespokojenost a počet členů posádky.
    \item Bocman: Kontroluje stav trupu - pokud se loď potopí, hra končí.
    \item Bednář: Hlídá lodní zásoby.
    \item Dělostřelec: Obsluhuje lodní děla, která se využívají především v soubojích.
    \item Pozorovatel: Hlídá průběh příběhu.
\end{itemize}
...
Samotné postavy také mají své vlastní deníky. Tyto deníky slouží jako záznamník pro vývoj postavy, který je reprezentován body souhvězdí, které postava získává během hry. Po konci příběhu se podle těchto bodů vyhodnotí, jaký osud postavu potkal.
