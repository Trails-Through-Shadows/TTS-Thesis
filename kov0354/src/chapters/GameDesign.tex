...
Příklady: \glsref{monopoly}, \textit{Carcassonne}, \textit{Šachy}, \textit{Race for the Galaxy}
...
Příklady: \textit{Pandemic}, \textit{Arkham Horror}, \glsref{gloomhaven}, \glsref{forgotten_waters}
