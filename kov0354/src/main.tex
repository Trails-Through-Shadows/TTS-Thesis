...
\Acknowledgement{%
Ráda bych na tomto místě poděkovala vedoucímu práce Ing. Radoslavu Fasugovi, Ph.D. za jeho cenné rady a podporu během tvorby této bakalářské práce. Dále bych chtěla poděkovat kolegům Pavlu Mikulovi, Martinu Korotwitschkovi a Miroslavu Osobovi za jejich aktivní zapojení, spolupráci a podněty v průběhu vývoje. V neposlední řadě poděkování směřuji svému příteli a rodině za jejich trpělivost a podporu během celého studia.
}
...
\CzechKeywords{hybridní desková hra; herní design}
...
\EnglishKeywords{hybrid board game; game design}
