...
\NewDocumentCommand{\chapterref}{mO{}}{(Kapitola \ref{#1}#2)}
\NewDocumentCommand{\sectionref}{mO{}}{(Sekce \ref{#1}#2)}
\NewDocumentCommand{\subsectionref}{mO{}}{(Podsekce \ref{#1}#2)}
\NewDocumentCommand{\tableref}{mO{}}{(Tabulka \ref{#1}#2)}
\NewDocumentCommand{\coderef}{mO{}}{(Výpis \ref{#1}#2)}
\NewDocumentCommand{\figureref}{mO{}}{(Obrázek \ref{#1}#2)}
\NewDocumentCommand{\listingref}{mO{}}{(Výpis \ref{#1}#2)}
