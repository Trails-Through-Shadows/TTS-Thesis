...
\usepackage[cpp]{../../shared/diplomalst}
...
\CzechThesisTitle{Tvorba API pro výpravnou hru}
\EnglishThesisTitle{Creating API for a Role-Playing Game}
\SubmissionYear{2024}
...
\input{chapters/intruduction.tex}
\input{chapters/standards.tex}
