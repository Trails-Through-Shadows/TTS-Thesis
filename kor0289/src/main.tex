...
\NewDocumentCommand{\chapterref}{mO{}}{(\hyperlink{#1}{Kapitola \ref*{#1}#2})}
...
\NewDocumentCommand{\figureref}{mO{}}{(\hyperlink{#1}{Obrázek \ref*{#1}#2})}
\NewDocumentCommand{\listingref}{mO{}}{(\hyperlink{#1}{Výpis \ref*{#1}#2})}
