...
\Acknowledgement{Jako první bych chtěl poděkoat všem členům týmu za aktivní spolupráci a zkušenosti na tomto projektu. Také bych chtěl poděkovat vedoucímu práce Ing. Radoslavu Fasugovi, Ph.D. za jeho vedení a rady. Dále svojí rodině a přátelům, bez kterých by bylo moje studium obtížné.}
\CzechAbstract{}
