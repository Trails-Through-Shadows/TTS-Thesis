...
% TODO: Zobrazit kroky jak to probíhá?
...
% Code example
\lstinputlisting[style=CUSTOMHTML, language=html, caption={Příklad šablony v jazyce DTL.}, label={lst:dtl_template}]{sourceCodes/TemplateExample.html}
