...
HTML neboli \textit{Hyper Text Markup Language} je značkovací jazyk určený pro tvorbu strukturovanch webových stránek. Za jeho vývojem stojí Tim Berners-Lee, který jej uvedl v roce 1993 jako součast prvního webového prohlížeče. HTML se tak stal základním stavebním prvkem všech webových stránek a je podporován všemi moderními prohlíči. Jeho syntaxe je založena na značkách, které definují jeho strukturu, jako příklad značek můžeme uvést blíže přiblížené značky z kapitoly~\ref{sec:admin-tags}.
